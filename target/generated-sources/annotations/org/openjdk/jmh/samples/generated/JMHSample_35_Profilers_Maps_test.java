...
import org.openjdk.jmh.infra.generated.Blackhole_jmh;
import org.openjdk.jmh.samples.generated.JMHSample_35_Profilers_Maps_jmh;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class JMHSample_35_Profilers_Maps_test {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JMHSample_35_Profilers_Maps_jmh l_maps0_0 = _jmh_tryInit_f_maps0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_maps0_0.test(l_blackhole1_2);
                res.allOps++;
            }

            test_thrpt_jmhStub(control, res, l_blackhole1_2, l_maps0_0, l_blackhole1_1);
    ...
    public void test_thrpt_jmhStub(InfraControl control, RawResults result, Blackhole_jmh l_blackhole1_2, JMHSample_35_Profilers_Maps_jmh l_maps0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_avgt_jmhStub(control, res, l_blackhole1_2, l_maps0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_maps0_0.test(l_blackhole1_2);
    ...
    public void test_avgt_jmhStub(InfraControl control, RawResults result, Blackhole_jmh l_blackhole1_2, JMHSample_35_Profilers_Maps_jmh l_maps0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_blackhole1_2, l_maps0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_maps0_0.test(l_blackhole1_2);
    ...
    public void test_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Blackhole_jmh l_blackhole1_2, JMHSample_35_Profilers_Maps_jmh l_maps0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            test_ss_jmhStub(control, batchSize, res, l_blackhole1_2, l_maps0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void test_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Blackhole_jmh l_blackhole1_2, JMHSample_35_Profilers_Maps_jmh l_maps0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    JMHSample_35_Profilers_Maps_jmh f_maps0_0;
    
    JMHSample_35_Profilers_Maps_jmh _jmh_tryInit_f_maps0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        JMHSample_35_Profilers_Maps_jmh val = f_maps0_0;
        if (val == null) {
            val = new JMHSample_35_Profilers_Maps_jmh();
                Field f;
            f = org.openjdk.jmh.samples.JMHSample_35_Profilers.Maps.class.getDeclaredField("type");
