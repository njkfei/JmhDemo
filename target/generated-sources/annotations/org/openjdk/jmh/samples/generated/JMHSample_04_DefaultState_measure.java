...
import org.openjdk.jmh.samples.generated.JMHSample_04_DefaultState_jmh;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class JMHSample_04_DefaultState_measure {
    ...
    public BenchmarkTaskResult measure_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JMHSample_04_DefaultState_jmh l_jmhsample_04_defaultstate0_0 = _jmh_tryInit_f_jmhsample_04_defaultstate0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_jmhsample_04_defaultstate0_0.measure();
                res.allOps++;
            }

            measure_thrpt_jmhStub(control, res, l_jmhsample_04_defaultstate0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                f_jmhsample_04_defaultstate0_0 = null;
                f_blackhole1_1 = null;
            }
    ...
    public void measure_thrpt_jmhStub(InfraControl control, RawResults result, JMHSample_04_DefaultState_jmh l_jmhsample_04_defaultstate0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult measure_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measure_avgt_jmhStub(control, res, l_jmhsample_04_defaultstate0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhsample_04_defaultstate0_0.measure();
    ...
    public void measure_avgt_jmhStub(InfraControl control, RawResults result, JMHSample_04_DefaultState_jmh l_jmhsample_04_defaultstate0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult measure_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measure_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_jmhsample_04_defaultstate0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_jmhsample_04_defaultstate0_0.measure();
    ...
    public void measure_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_04_DefaultState_jmh l_jmhsample_04_defaultstate0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult measure_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            measure_ss_jmhStub(control, batchSize, res, l_jmhsample_04_defaultstate0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void measure_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_04_DefaultState_jmh l_jmhsample_04_defaultstate0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    JMHSample_04_DefaultState_jmh f_jmhsample_04_defaultstate0_0;
    
    JMHSample_04_DefaultState_jmh _jmh_tryInit_f_jmhsample_04_defaultstate0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        JMHSample_04_DefaultState_jmh val = f_jmhsample_04_defaultstate0_0;
        if (val == null) {
            val = new JMHSample_04_DefaultState_jmh();
            f_jmhsample_04_defaultstate0_0 = val;
        }
        return val;
    }
