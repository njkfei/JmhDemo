...
import org.openjdk.jmh.samples.generated.JMHSample_35_Profilers_Atomic_jmh;
import org.openjdk.jmh.infra.generated.Blackhole_jmh;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class JMHSample_35_Profilers_Atomic_test {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JMHSample_35_Profilers_Atomic_jmh l_atomic0_G = _jmh_tryInit_f_atomic0_G(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_atomic0_G.test());
                res.allOps++;
            }

            test_thrpt_jmhStub(control, res, l_atomic0_G, l_blackhole1_0);
            ...
            if (control.isLastIteration()) {
                if (JMHSample_35_Profilers_Atomic_jmh.tearTrialMutexUpdater.compareAndSet(l_atomic0_G, 0, 1)) {
                    try {
                        if (l_atomic0_G.readyTrial) {
                            l_atomic0_G.readyTrial = false;
                        }
                    } finally {
                        JMHSample_35_Profilers_Atomic_jmh.tearTrialMutexUpdater.set(l_atomic0_G, 0);
                    }
                } else {
                    long l_atomic0_G_backoff = 1;
                    while (JMHSample_35_Profilers_Atomic_jmh.tearTrialMutexUpdater.get(l_atomic0_G) == 1) {
                        TimeUnit.MILLISECONDS.sleep(l_atomic0_G_backoff);
                        l_atomic0_G_backoff = Math.max(1024, l_atomic0_G_backoff * 2);
    ...
    public void test_thrpt_jmhStub(InfraControl control, RawResults result, JMHSample_35_Profilers_Atomic_jmh l_atomic0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_avgt_jmhStub(control, res, l_atomic0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_atomic0_G.test());
    ...
    public void test_avgt_jmhStub(InfraControl control, RawResults result, JMHSample_35_Profilers_Atomic_jmh l_atomic0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_atomic0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_atomic0_G.test());
    ...
    public void test_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_35_Profilers_Atomic_jmh l_atomic0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            test_ss_jmhStub(control, batchSize, res, l_atomic0_G, l_blackhole1_0);
            control.preTearDown();
    ...
    public void test_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_35_Profilers_Atomic_jmh l_atomic0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile JMHSample_35_Profilers_Atomic_jmh f_atomic0_G;
    
    JMHSample_35_Profilers_Atomic_jmh _jmh_tryInit_f_atomic0_G(InfraControl control, ThreadParams threadParams) throws Throwable {
        JMHSample_35_Profilers_Atomic_jmh val = f_atomic0_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new JMHSample_35_Profilers_Atomic_jmh();
            val.setup();
            val.readyTrial = true;
            f_atomic0_G = val;
        }
