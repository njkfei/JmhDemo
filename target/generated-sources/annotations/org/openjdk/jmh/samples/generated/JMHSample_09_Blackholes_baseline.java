...
public final class JMHSample_09_Blackholes_baseline {
    ...
    public BenchmarkTaskResult baseline_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_jmhsample_09_blackholes0_0.baseline());
                res.allOps++;
            }

            baseline_thrpt_jmhStub(control, res, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
    ...
    public void baseline_thrpt_jmhStub(InfraControl control, RawResults result, JMHSample_09_Blackholes_jmh l_jmhsample_09_blackholes0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult baseline_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            baseline_avgt_jmhStub(control, res, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_09_blackholes0_0.baseline());
    ...
    public void baseline_avgt_jmhStub(InfraControl control, RawResults result, JMHSample_09_Blackholes_jmh l_jmhsample_09_blackholes0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult baseline_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            baseline_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jmhsample_09_blackholes0_0.baseline());
    ...
    public void baseline_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_09_Blackholes_jmh l_jmhsample_09_blackholes0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult baseline_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            baseline_ss_jmhStub(control, batchSize, res, l_jmhsample_09_blackholes0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void baseline_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JMHSample_09_Blackholes_jmh l_jmhsample_09_blackholes0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
